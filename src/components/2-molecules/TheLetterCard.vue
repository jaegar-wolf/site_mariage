...
<template>
  <div id="invite" class="h-160 md:h-200 w-full my-20 relative flex">
    <div class="hidden md:block h-full w-1/2">
      <img :src="inviteCardUs" class="size-full" />
    </div>
    <div class="h-full w-full md:w-1/2 flex flex-col items-center mt-10 md:mt-20 gap-6">
      <div class="font-forum font-bold text-2xl w-60 text-center">
        VOUS ÊTES INVITEZ AU MARIAGE DE
      </div>
      <div class="flex flex-col gap-8 items-center">
        <span class="font-dynalight text-neutral text-6xl md:text-8xl font-normal">Mathieu</span>
        <div class="w-14 h-14">
          <WeddingRing />
        </div>
        <span class="font-dynalight text-neutral text-6xl md:text-8xl font-normal">Mélanie</span>
      </div>
